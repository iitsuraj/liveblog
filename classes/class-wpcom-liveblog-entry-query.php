...
class WPCOM_Liveblog_Entry_Query {
	...
	public function get_all_entries_desc() {
		$cached_entries_desc_key = $this->key . '_entries_desc_' . $this->post_id;
		$cached_entries_desc     = wp_cache_get( $cached_entries_desc_key, 'liveblog' );
